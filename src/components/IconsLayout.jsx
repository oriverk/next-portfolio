...
import { IconsPermanentDrawerLists, IconsLeftSwipeDrawerLists } from './IconsDrawerLists'
import { AlgoliaSearch } from './search/AlgoliaSearch'

import { Divider } from '../utils/utils'

export function IconsLayout(props) {
    ...
    <React.Fragment>
      ...
      <aside>
        <div className='permanentDrawer'>
          <IconsPermanentDrawerLists home={props.home} posts={props.posts} />
          <Divider />
